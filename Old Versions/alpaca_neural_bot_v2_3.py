...
def backtest(
    ...
    """Run a backtest simulation with dynamic stop-losses, RSI filters, and transaction costs."""
    ...
    for i in range(k_start, len(predictions)):
        ...
        if pred > buy_threshold and position == 0 and qty > 0 and current_rsi < 30:
            position = qty
            entry_price = price
            entry_time = ts  # Record entry time as pandas Timestamp
            ...
            # Ensure entry_time is a pandas Timestamp
