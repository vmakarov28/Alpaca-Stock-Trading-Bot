...
CONFIG = {
    ...
    'TRAILING_STOP_PERCENTAGE': 0.9,  # Percentage for trailing stop (widened slightly)
...
#python /mnt/c/Users/aipla/Downloads/alpaca_neural_bot_v9.0.1.py --backtest --force-train
