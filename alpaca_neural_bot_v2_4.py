# alpaca_neural_bot_v2_3.py
# Version 2.3 - Fixed AttributeError in backtest function by ensuring timestamps are pandas.Timestamp objects.
# Enhanced with Trailing Stop-Loss, Volatility-Based Position Sizing, Confidence Threshold, No-Trade Zone, and ADX Indicator.
...
CONFIG = {
    ...
    'CONFIDENCE_THRESHOLD': 0.50,  # New: Confidence threshold for trades
    'TRAILING_STOP_PERCENTAGE': 0.02,  # New: Trailing stop percentage
    'MAX_VOLATILITY': 0.5,  # New: No-trade zone volatility limit
    'ADX_TREND_THRESHOLD': 15,  # New: ADX threshold for trending market
    'RISK_PERCENTAGE': 0.02  # New: Risk percentage for position sizing
}
